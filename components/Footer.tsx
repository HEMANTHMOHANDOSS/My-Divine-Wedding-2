      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
               <div className="w-10 h-10">
                 <img src="/logo.png" alt="My Divine Wedding" className="w-full h-full object-contain" />
               </div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-6">
              The most trusted and premium matchmaking service for Tamilians worldwide. Bringing hearts together with tradition and technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: 'About Us', id: 'landing' }, 
                { label: 'Contact Us', id: 'landing', section: 'contact' },
                { label: 'Success Stories', id: 'landing', section: 'stories' }
              ].map(item => (
                <li key={item.label}>
                  <a 
          ...
          <div>
            <h4 className="font-serif font-bold text-gray-900 dark:text-white mb-6">Help & Support</h4>
            <ul className="space-y-3">
              {[
                { label: 'FAQs', id: 'faq' },
          ...
          <div>
            <h4 className="font-serif font-bold text-gray-900 dark:text-white mb-6">Get the App</h4>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
              Experience the best matchmaking on the go.
            </p>
            <div className="space-y-3">
              <button className="group relative w-full flex items-center gap-3 px-4 py-3 bg-black dark:bg-white/5 text-white rounded-xl overflow-hidden transition-transform active:scale-95">
                ...
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 opacity-0 group-hover:opacity-100 -z-10 blur-md transition-opacity duration-300"></div>
        ...
        <div className="border-t border-gray-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 dark:text-gray-500 text-sm text-center md:text-left">
            © 2024 My Divine Wedding. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-500">
              Made with <Heart size={14} className="text-red-500 fill-red-500 animate-pulse" /> for the Tamil Community
            </div>
